# Update [Ranks] by [Teams]:
scoreboard players set @s[team=mcs_member] mcs_ranks 1
scoreboard players set @s[team=mcs_vip] mcs_ranks 2
scoreboard players set @s[team=mcs_builder] mcs_ranks 3
