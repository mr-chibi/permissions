...
scoreboard objectives add kill_zombie_vil minecraft.killed:minecraft.zombie_villager
scoreboard objectives add kill_husk minecraft.killed:minecraft.husk
scoreboard objectives add kill_drown minecraft.killed:minecraft.drowned

#
scoreboard objectives add kill_spider minecraft.killed:minecraft.spider
scoreboard objectives add kill_cav_spider minecraft.killed:minecraft.cave_spider
...
scoreboard objectives add kill_eld_guard minecraft.killed:minecraft.elder_guardian
...
#
scoreboard objectives add kill_zom_piglin minecraft.killed:minecraft.zombified_piglin
scoreboard objectives add kill_ghast minecraft.killed:minecraft.ghast
scoreboard objectives add kill_wither_ske minecraft.killed:minecraft.wither_skeleton
...
#
scoreboard objectives add kill_enderdrag minecraft.killed:minecraft.ender_dragon
