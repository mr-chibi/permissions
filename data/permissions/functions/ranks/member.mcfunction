...
# Member Homes 1:
###################################################################################
execute as @s[scores={sethome_1=1..}] run function permissions:commands/homes/sethome_1
execute as @s[scores={delhome_1=1..}] run function permissions:commands/homes/delhome_1
...
# Member Homes 2:
###################################################################################
execute as @s[scores={sethome_2=1..}] run function permissions:commands/homes/sethome_2
execute as @s[scores={delhome_2=1..}] run function permissions:commands/homes/delhome_2
...
# Member Homes 3:
###################################################################################
execute as @s[scores={sethome_3=1..}] run function permissions:commands/homes/sethome_3
execute as @s[scores={delhome_3=1..}] run function permissions:commands/homes/delhome_3
